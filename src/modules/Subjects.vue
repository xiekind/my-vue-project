  ...
  <div id="card">
    <b-container>
      <b-row>
        ...
        <b-col>
          <div class="float-left" id="addCourse">
          ...
          <div class="float-right" id="removeCourse">
            <b-button style="width:100px" block variant="outline-primary" v-b-toggle.collapse-2 class="m-1" >Remove Course</b-button>
            <b-collapse id="collapse-2">
              <b-card>
                <b-form-group>
                  Course:
                  <b-form-input required v-model="deleteContent.deleteCourse" id="subject"></b-form-input>
                  <br>
...
export default {
  ...
  methods: {
    addItem() {
      ...
      this.contents.course = "";
      (this.contents.year = ""), (this.contents.schedule = "");
      this.contents.room = "";
      this.contents.teacher = "";
    },
    remove() {
